...
//
////            Log.e("NAV", "BACKSTACK before navigate:")
////            navHostController.currentBackStack.value.forEach {
////                Log.e("NAV", " • ${it.destination.route}")
////            }
//
//
//
//            /*
//            chahe "login/signup" likho ya "main_Graph"
//ViewModel destroy hone ka guarantee nahi milega
//
//Isliye:
//UID Flow + Room clear on logout = PROFESSIONAL SOLUTION
//ViewModel destroy ka wait = BUGGY DESIGN
//             */
